...
var permissions = ['user_status', 'publish_checkins','publish_actions'];
...
//alert(session.authResponse.accessToken);
        //response.session.access_token but response.authResponse.accessToken
...
function promptLogin() {
  FB.login(null, {scope: 'publish_stream,manage_pages'});
}
